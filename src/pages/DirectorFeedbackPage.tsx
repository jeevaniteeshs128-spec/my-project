    ...
    <div className='space-y-6'>
      <section className='relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#162033]'>
        ...
        <div className='relative p-4 sm:p-6 lg:p-8'>
          <Badge variant='gold' className='w-fit gap-1'><Star className='h-3.5 w-3.5' /> Verified Creator Dashboard</Badge>
          <h1 className='mt-3 text-3xl font-semibold text-white sm:text-4xl'>{dashboard.directorName}</h1>
          <p className='mt-2 max-w-2xl text-sm leading-6 text-slate-300'>
            This dashboard receives private Creator Feedback from verified Premium Critics. It emphasizes clarity, respect, and actionable suggestions.
          </p>
          <div className='mt-4 flex flex-wrap gap-2'>
            <Badge variant='brand'>{dashboard.verifiedDirector ? 'Verified Director' : 'Director Account'}</Badge>
            <Badge variant='ghost'>Private critic inbox</Badge>
            <Badge variant='ghost'>Premium creator workflow</Badge>
          </div>
        </div>
      </section>
      ...
      <section className='grid gap-4 lg:grid-cols-[1fr_.9fr]'>
        <Card>
          <CardHeader>
            <CardTitle>Top Private Feedback</CardTitle>
            <CardDescription>Curated constructive notes from verified Premium Critics.</CardDescription>
          </CardHeader>
          <CardContent className='space-y-3'>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>A private bridge between the official creator profile and the critic workflow.</CardDescription>
          </CardHeader>
          <CardContent className='space-y-3 text-sm leading-6 text-slate-200'>
            <p>
              Feedback is intentionally curated to remain respectful, specific, and useful. It is delivered privately rather than as a public review thread.
            </p>
            <p>
              The strongest notes rise to the top when they are verified, constructive, and supported by clear examples or scene-level references.
            </p>
